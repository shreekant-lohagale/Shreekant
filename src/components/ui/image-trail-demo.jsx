  ...
  return (
    <div className="flex w-full min-h-screen justify-center items-center bg-stone-900 relative overflow-hidden px-4 sm:px-6 lg:px-8">
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 md:px-8">
        {/* --- Heading --- */}
        <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-bold mb-4 sm:mb-6 select-none bg-clip-text text-transparent bg-gradient-to-r from-green-500 via-emerald-400 to-green-600">
          ACHIEVEMENTS
        </h1>

        {/* --- Description --- */}
        <p className="text-base sm:text-lg md:text-xl text-stone-300 mb-8 sm:mb-10 max-w-2xl mx-auto leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-10">
          ...
          <a
            ...
            className="px-6 sm:px-8 py-2.5 sm:py-3 bg-green-600 hover:bg-green-700 text-white rounded-full font-semibold transition-all duration-300 hover:shadow-lg hover:shadow-green-500/30 flex items-center gap-2 text-sm sm:text-base"
          >
          ...
          {/* Download Portfolio */}
          <button className="px-6 sm:px-8 py-2.5 sm:py-3 border border-stone-500 hover:border-green-500 text-stone-300 hover:text-green-400 rounded-full font-semibold transition-all duration-300 flex items-center gap-2 text-sm sm:text-base">
